...
if(args[0].toLowerCase() === "utility") {
    ...
    if (!command) {
      (embed.setTitle("**Invalid Command!**").setDescription(`**Do \`${prefix}help\` For the List Of the Commands!**`))
    } else {
